...
// Users 
export const login = async (el: any) => axios.post("auth/signin", el).then(res => res.data).catch(err => err)

export const register = async (el: any) => axios.post("auth/register", el).then(res => res.data).catch(err => err)

...
exports.deleteCatalogId = exports.putCatalogId = exports.getCatalogId = exports.postCatalog = exports.getCatalog = exports.patchInvoices = exports.getInvoices = exports.postStockReceive = exports.patchStock = exports.putStock = exports.getStock = exports.patchBillsInvoicesIdTitle = exports.getBillsInvoicesOwnerId = exports.getBillsUsersUserId = exports.getBillsCostCostId = exports.getBillsBillIdPdf = exports.postBillsBillIdPay = exports.getBillsBillId = exports.postBills = exports.getBills = exports.deleteUsersId = exports.putUsersId = exports.postUsers = exports.getUsers = exports.postAuthSignin = void 0;
/**
...
const postAuthSignin = (authRequest) => {
    return (0, axiostance_1.axiosInstance)({ url: `/auth/signin`, method: 'POST',
...
const getUsers = (params) => {
    return (0, axiostance_1.axiosInstance)({ url: `/users`, method: 'GET',
        params
    });
};
...
const postUsers = (createUser) => {
    return (0, axiostance_1.axiosInstance)({ url: `/users`, method: 'POST',
        headers: { 'Content-Type': 'application/json', },
        data: createUser
    });
};
...
const putUsersId = (id, updateUser) => {
    return (0, axiostance_1.axiosInstance)({ url: `/users/${id}`, method: 'PUT',
        headers: { 'Content-Type': 'application/json', },
        data: updateUser
    });
};
...
const getBills = (params) => {
    return (0, axiostance_1.axiosInstance)({ url: `/bills`, method: 'GET',
        params
    });
};
...
const postBills = (billCreate) => {
    return (0, axiostance_1.axiosInstance)({ url: `/bills`, method: 'POST',
        headers: { 'Content-Type': 'application/json', },
        data: billCreate
    });
};
...
const postBillsBillIdPay = (billId, postBillsBillIdPayBody) => {
    return (0, axiostance_1.axiosInstance)({ url: `/bills/${billId}/pay`, method: 'POST',
        headers: { 'Content-Type': 'application/json', },
...
const getBillsBillIdPdf = (billId) => {
    return (0, axiostance_1.axiosInstance)({ url: `/bills/${billId}/pdf`, method: 'GET',
        responseType: 'blob'
    });
};
...
const patchBillsInvoicesIdTitle = (id, invoiceTitleUpdate) => {
    return (0, axiostance_1.axiosInstance)({ url: `/bills/invoices/${id}/title`, method: 'PATCH',
        headers: { 'Content-Type': 'application/json', },
...
const putStock = (stockAvailability) => {
    return (0, axiostance_1.axiosInstance)({ url: `/stock`, method: 'PUT',
        headers: { 'Content-Type': 'application/json', },
...
const patchStock = (stockPriceUpdate) => {
    return (0, axiostance_1.axiosInstance)({ url: `/stock`, method: 'PATCH',
        headers: { 'Content-Type': 'application/json', },
...
const postStockReceive = (stockReceive) => {
    return (0, axiostance_1.axiosInstance)({ url: `/stock/receive`, method: 'POST',
        headers: { 'Content-Type': 'application/json', },
        data: stockReceive
    });
};
...
const patchInvoices = (patchInvoicesBody) => {
    return (0, axiostance_1.axiosInstance)({ url: `/invoices`, method: 'PATCH',
        headers: { 'Content-Type': 'application/json', },
...
const postCatalog = (catalogItemCreate) => {
    return (0, axiostance_1.axiosInstance)({ url: `/catalog`, method: 'POST',
        headers: { 'Content-Type': 'application/json', },
...
const putCatalogId = (id, catalogItemUpdate) => {
    return (0, axiostance_1.axiosInstance)({ url: `/catalog/${id}`, method: 'PUT',
        headers: { 'Content-Type': 'application/json', },
